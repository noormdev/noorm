...
function RouteDisplay() {
    ...
    return (
        <Text>
            route:{route}|section:{section}|canGoBack:{String(canGoBack)}|historyLen:{history.length}|params:{JSON.stringify(params)}
        </Text>
    )
}
...
describe('cli: router', () => {
    ...
    describe('useRouter', () => {
        ...
        it('should throw when used outside RouterProvider', () => {
            ...
            expect(output).toContain('useRouter must be used within a RouterProvider')
    ...
    describe('useRoute', () => {
        ...
        it('should return route, params, and section', () => {
            ...
            function RouteOnly() {
                ...
                return <Text>route:{route}|section:{section}|params:{JSON.stringify(params)}</Text>
            }
    ...
    describe('useNavigation', () => {
        ...
        it('should return only navigation functions', () => {
            ...
            function NavigationOnly() {
                ...
                return (
                    <Text>
                        navigate:{String(hasNavigate)}|back:{String(hasBack)}|replace:{String(hasReplace)}|reset:{String(hasReset)}|canGoBack:{String(hasCanGoBack)}
                    </Text>
                )
            }
