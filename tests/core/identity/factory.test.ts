...
describe('identity: factory', () => {
    ...
    describe('createCryptoIdentity', () => {
        ...
        it('should throw if name is empty', async () => {
            ...
            await expect(createCryptoIdentity({
                name: '',
                email: 'test@example.com',
            }, false)).rejects.toThrow(/name/i)
        })
    ...
    describe('regenerateKeyPair', () => {
        ...
        it('should generate new keypair', async () => {
            ...
            const { identity: updated, keypair: newKeypair } = await regenerateKeyPair(original, false)
