...
describe('changeset: parser', () => {
    ...
    describe('resolveManifest', () => {
        ...
        it('should throw ManifestReferenceError for missing file', async () => {
            ...
            await expect(resolveManifest(manifestPath, SCHEMA_DIR))
                .rejects.toThrow(ManifestReferenceError)
        })
    ...
    describe('validateChangeset', () => {
        ...
        it('should throw for duplicate filenames in change/', () => {
            ...
            const changeset = {
                ...
                description: 'test',
                changeFiles: [
                    { filename: '001_dup.sql', path: '/test/change/001_dup.sql', type: 'sql' as const },
                    { filename: '001_dup.sql', path: '/test/change/001_dup.sql', type: 'sql' as const },
                ],
                revertFiles: [],
                hasChangelog: false,
        ...
        it('should throw for duplicate filenames in revert/', () => {
            ...
            const changeset = {
                ...
                changeFiles: [],
                revertFiles: [
                    { filename: '001_dup.sql', path: '/test/revert/001_dup.sql', type: 'sql' as const },
                    { filename: '001_dup.sql', path: '/test/revert/001_dup.sql', type: 'sql' as const },
                ],
                hasChangelog: false,
            }
