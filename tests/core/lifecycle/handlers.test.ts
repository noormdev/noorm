    ...
    describe('registerExceptionHandlers', () => {
        ...
        it('should emit app:exception on unhandledRejection', async () => {
            ...
            if (listeners.length > 0) {
                ...
                ;(listeners[listeners.length - 1] as (reason: unknown, p: Promise<unknown>) => void)(error, promise)
            }
        ...
        it('should convert non-Error rejection to Error', async () => {
            ...
            if (listeners.length > 0) {
                ...
                ;(listeners[listeners.length - 1] as (reason: unknown, p: Promise<unknown>) => void)('String rejection', promise)
            }
