...
describe('lock: errors', () => {
    ...
    describe('LockAcquireError', () => {
        ...
        it('should be instanceof Error', () => {
            ...
            const error = new LockAcquireError('dev', 'alice@example.com', new Date(), new Date());
    ...
    describe('LockExpiredError', () => {
        ...
        it('should have correct name', () => {
            ...
            const error = new LockExpiredError('dev', 'alice@example.com', new Date());
        ...
        it('should store all properties', () => {
            ...
            const error = new LockExpiredError('dev', 'alice@example.com', expiredAt);
    ...
    describe('LockOwnershipError', () => {
        ...
        it('should have correct name', () => {
            ...
            const error = new LockOwnershipError('dev', 'bob@example.com', 'alice@example.com');
