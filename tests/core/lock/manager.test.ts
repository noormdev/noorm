...
describe('lock: manager', () => {
    ...
    describe('release', () => {
        ...
        it('should throw LockNotFoundError when no lock exists', async () => {
            ...
            await expect(
                manager.release(db, 'dev', 'alice@example.com')
        ...
        it('should throw LockOwnershipError when releasing others lock', async () => {
            ...
            await expect(
                manager.release(db, 'dev', 'bob@example.com')
    ...
    describe('validate', () => {
        ...
        it('should succeed when lock is valid', async () => {
            ...
            await expect(
                manager.validate(db, 'dev', 'alice@example.com')
        ...
        it('should throw LockOwnershipError when lock held by another', async () => {
            ...
            await expect(
                manager.validate(db, 'dev', 'bob@example.com')
            ).rejects.toThrow(LockOwnershipError)
        })
    ...
    describe('extend', () => {
        ...
        it('should fail if lock does not exist', async () => {
            ...
            await expect(
                manager.extend(db, 'dev', 'alice@example.com')
            ).rejects.toThrow(LockNotFoundError)
        })
        ...
        it('should fail if lock is held by another', async () => {
            ...
            await expect(
                manager.extend(db, 'dev', 'bob@example.com')
            ).rejects.toThrow(LockOwnershipError)
        })
    })
