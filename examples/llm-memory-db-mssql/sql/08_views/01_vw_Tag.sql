...
-- vw_Tag
-- -----------------------------------------------------------------------------
-- One row per tag-entity attachment. Tags with zero attachments do not appear.
-- UNION ALL across the 5 *_Tag join tables. Unused entity columns default to 0.
--
-- Columns:
--   tag_id, name, description, reason, provenance_id,
--   relation_type ('project'|'memory'|'artifact'|'milestone'|'task'),
--   project_id, memory_id, artifact_id, milestone_id, task_no,
