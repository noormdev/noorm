CREATE TABLE [dbo].[Artifact] (
    ...
    CONSTRAINT [FK_Artifact_RelevanceStatus] FOREIGN KEY ([relevance_status])
        REFERENCES [dbo].[RelevanceStatus] ([relevance_status])
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT [FK_Artifact_Project] FOREIGN KEY ([provenance_id])
        REFERENCES [dbo].[Project] ([project_id])
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT [FK_Artifact_Agent] FOREIGN KEY ([agent_id])
