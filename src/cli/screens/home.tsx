...
import { Panel, Spinner, Badge } from '../components/index.js'
    ...
    useEffect(() => {
        ...
        const loadStatus = async () => {
            ...
            const [result, err] = await attempt(async () => {
                ...
                const conn = await createConnection(activeConfig.connection, activeConfigName ?? '__status__')
        ...
        return (
            <Box flexDirection="column" padding={1}>
                ...
                <Panel title="Select Config" paddingX={2} paddingY={1} borderColor="yellow">
                    <Box flexDirection="column" gap={1}>
                        <Text>You have <Text color="cyan">{configs.length}</Text> configuration(s), but none is active.</Text>
                        <Box marginTop={1}>
                            <Text>Press </Text>
                            <Text color="cyan" bold>[c]</Text>
    ...
    return (
        <Box flexDirection="column" padding={1}>
            ...
            <Box marginBottom={1} gap={2}>
                ...
                <Text color="cyan" bold>{activeConfigName ?? 'none'}</Text>
                <Text dimColor>|</Text>
