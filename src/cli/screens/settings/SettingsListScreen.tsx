        ...
        () => [
            {
                ...
                description: `File patterns for schema builds (${buildSectionSummary(settings)})`,
            },
            {
                key: 'paths',
                label: 'Paths',
                value: { key: 'paths', route: 'settings/paths' as Route },
                description: `Default directories for SQL and changes (${pathsSectionSummary(settings)})`,
            },
            {
                key: 'stages',
                label: 'Stages',
                value: { key: 'stages', route: 'settings/stages' as Route },
                description: `Deployment environments and their defaults (${stagesSectionSummary(settings)})`,
            },
            {
                key: 'rules',
                label: 'Rules',
                value: { key: 'rules', route: 'settings/rules' as Route },
                description: `Conditional build include/exclude patterns (${rulesSectionSummary(settings)})`,
            },
            {
                key: 'strict',
                label: 'Strict',
                value: { key: 'strict', route: 'settings/strict' as Route },
                description: `Enforce required stages before operations (${strictSectionSummary(settings)})`,
            },
            {
                key: 'logging',
                label: 'Logging',
                value: { key: 'logging', route: 'settings/logging' as Route },
                description: `File logging configuration (${loggingSectionSummary(settings)})`,
            },
            {
                key: 'secrets',
                label: 'Secrets',
                value: { key: 'secrets', route: 'settings/secrets' as Route },
                description: `Required secrets for all stages (${secretsSectionSummary(settings)})`,
            },
        ],
        [settings],
    );
