 ...
 * change: a mouse report is dropped instead of typed into the field. It also
 * registers with `useTextEntry` while enabled, which changes nothing about the
 * field itself and tells `GlobalKeyboard` to leave its keystrokes alone.
 *
