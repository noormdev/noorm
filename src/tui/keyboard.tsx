...
export function GlobalKeyboard({
    ...
    useInput((input, key) => {
        ...
        // Every shortcut but Ctrl+C is a printable key. While a text field is
        // taking keystrokes, that key is the user's text, not a command.
