...
export const v1: SchemaMigration = {
    ...
    async up(db: Kysely<unknown>): Promise<void> {
        ...
        await db.schema
            ...
            .addColumn('executed_by', 'varchar(255)', col =>
                col.notNull().defaultTo('')
            )
            .addColumn('config_name', 'varchar(255)', col =>
                col.notNull().defaultTo('')
            )
            .addColumn('cli_version', 'varchar(50)', col =>
                col.notNull().defaultTo('')
            )
            .addColumn('status', 'varchar(50)', col => col.notNull())
            .addColumn('error_message', 'text', col =>
                col.notNull().defaultTo('')
            )
        ...
        await db.schema
            ...
            .addColumn('skip_reason', 'varchar(100)', col =>
                col.notNull().defaultTo('')
            )
            .addColumn('duration_ms', 'integer', col =>
                col.notNull().defaultTo(0)
        ...
        await db.schema
            ...
            .addColumn('reason', 'varchar(255)', col =>
                col.notNull().defaultTo('')
            )
            .execute()
        ...
        await db.schema
            ...
            .addColumn('id', 'serial', col => col.primaryKey())
            .addColumn('identity_hash', 'varchar(64)', col =>
                col.notNull().unique()
            )
