...
|------|-------------|---------|
| **change** | Migration execution | `change run`, `change ff`, `change next` |
...
|-----------|-------|---------|
| `[CHANGESET]` | Cyan | Migration execution |
...
This helps identify slow migrations or unexpected performance issues.
...
- [Changes](/guide/migrations/changes) - Change directory structure and file types
