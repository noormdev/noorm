...
You've run your schema builds and changesets. The database says "success." But did everything actually get created? Are the columns right? Do the foreign keys point where they should?
...
5. **Debug migrations** - When changesets fail, explore the current schema state to understand what exists.
